...
function theme_scripts(){
    ...
    if ( !is_admin() ) {
        ...
        wp_register_script('main-css', ASSETS_URL . '/assets/js/main.js', array('jquery'), '1.0', true);
        wp_enqueue_script('main-css');
    }
}
...
function theme_stylesheets(){
	...
	$styles_path = ASSETS_URL . '/assets/style.css';

	if( $styles_path ) {
	   
        wp_register_style('fonts', 'https://fonts.googleapis.com/css?family=Montserrat:300,300i,400,400i,500,700,700i|Roboto+Slab:300,400,700', array(), false, 'all');
        wp_register_style('fa', 'https://maxcdn.bootstrapcdn.com/font-awesome/4.6.3/css/font-awesome.min.css', array(), false, 'all');
		wp_register_style('style-css', ASSETS_URL . '/assets/style.css', array('fonts', 'fa'), false, 'all');
